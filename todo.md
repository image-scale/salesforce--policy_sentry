...
- [x] Task 2: Implement ARN parsing and matching (parse ARNs, match user ARNs to database ARN formats)
- [x] Task 3: Implement action querying (get action data, filter by access level, filter by resource type)
